...
const startSteps = [
  ...
  },
  {
    ...
    body: 'Use measured values when available and mark unknown conditions for field verification.',
  },
  {
    title: 'Read the spec summary',
    body: 'Start with the recommended setup, footprint, operating path, and confidence label.',
  },
  {
    title: 'Inspect the details',
    body: 'Use sizing results, coverage scenarios, one-lines, and risk review to challenge the recommendation.',
  },
  {
...
const workflowTutorials: WorkflowTutorial[] = [
  ...
  },
  {
    ...
    icon: Workflow,
    steps: [
      'Separate the customer peak and continuous load profile.',
      'Select the rental BESS by verified continuous kW and usable kWh; never size from a peak/model number.',
